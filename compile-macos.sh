#!/usr/bin/env bash
# compile-macos.sh - compiles inspectcode-tui into a standalone macOS binary with Nuitka.
#
...
# libraries, and dist/inspectcode-tui-vX.Y.Z-macos-<arch>.tar.gz ready to hand out.
#
...
#     xattr -dr com.apple.quarantine inspectcode-tui
...
echo "Compiling inspectcode-tui v$version ($arch) with Nuitka..."
...
tarball="$out_dir/inspectcode-tui-v$version-macos-$arch.tar.gz"
rm -f "$tarball"
